		...
		<div class="cart_table">		
			...
			<div class="tip_5">
				<p>
					...
					应付金额：<strong>${sum_price}</strong>元&nbsp;&nbsp;&nbsp;&nbsp;
					支付方式：在线支付&nbsp;&nbsp;&nbsp;&nbsp;
					配送方式：京东快递&nbsp;&nbsp;&nbsp;&nbsp;
			...
			<div class="tip_6">
				  ...
				  <span style="margin-left: 90px;"><a target="_blank" href="orderInfo?orderId=${orderId}">查看订单状态</a></span>&nbsp;&nbsp;<a target="_blank" href="#">查看银行限额帮助</a>
			</div>	
