...
<div id="bodyPart">
    ...
    <ul class="Tab">
    	<li class="curr"><em><a href="orderList?userId=${jdUser.userId}">我的订单</a></em></li>
    	<li ><em><a href="preOrderList.jsp">查看一个月前订单</a></em></li>
		<li ><em><a href="orderList?userId=${jdUser.userId}&status=已取消">查看已取消订单</a></em></li>
	</ul>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
			...
			<c:forEach items="${orderList}" var="order">
				<tr height="55" id="order_info">
					...
					<td><a href='#'><img src='img/ln_cart1.jpg'/></a></td>
					<td class="black">曾庆武</td>
					<td class="black">￥${order.totalPrice}<br />货到付款</td>
					<td>2011-02-03 <br/> ${order.orderTime}</td>
					<td>${order.status}</td>
