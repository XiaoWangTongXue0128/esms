...
<div id="bodyPart">
	...
	<div id="cart_left">
    	<div id="succeed">
			...
			<div class="success">
            	<b>&nbsp;</b>
                <a href="toMyCart" class="btn_pay" ></a>
                <a onclick="javascript:window.history.go(-1);" class="btn_continue"></a>
            </div>
			<div id="cart_yb"></div>
		</div>
        ...
        <div class="m" id="mycart_detail">
			...
			<div id="cart_content">
                ...
                <div class="cart_total">
                	共<b>${sunm_count}</b>件商品<br />
					金额总计：<b>￥${sunm_price}</b>
                </div>
                <div><a href="toMyCart" class="btn_pay"></a></div>
			</div>
         </div>   
    </div>
