...
<div id="bodyPart">
  ...
  <div class="main">
	...
	<div class="order_state">
    	<div class="opr_order">
            <strong>订单号：${orderId}&nbsp;&nbsp;    状态：
                <span>
                    <c:if test="${empty payMsg}">等待付款</c:if>
                    <c:if test="${not empty payMsg}">${payMsg}</c:if>
                </span></strong>
            <div class="state_btn">
                <ul>
                	<li><a href="alipay.jsp?orderId=${orderId}">支付</a></li>
    ...
    <div id="order_text">
        ...
        <div class="order_total">
            ...
            <div class="m_total"><b>订单支付金额：￥<span>${sum_price}</span></b></div>
        </div>
    </div>
