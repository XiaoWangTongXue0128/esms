           ...
           <form action="register.do" method="post" id="register_form">
           	<div class="user_form"> 
                ...
                <div class="uInfo">
                    ...
                    <input type="password" name="password" class="text pass1" />
                </div> 
                <div class="uInfo">
                	<span class="label">确认密码：</span>
                    <input type="password" name="password1" class="text pass2"/>
                </div>
                <div class="uInfo">
                ...
                <div class="uInfo">
                    ...
                    <button type="button" id="button" onclick="register()">同意以下协议，提交</button>
                    ${msg}
